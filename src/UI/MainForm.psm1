...
function Show-PBIAutomateMainForm {
    ...
    [void]$rootGrid.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute,150)))
    ...
    function New-Label([string]$text) { $l=New-Object System.Windows.Forms.Label; $l.Text=$text; $l.Dock='Fill'; $l.TextAlign='MiddleLeft'; return $l }
    $txtPath=New-Object System.Windows.Forms.TextBox; $txtPath.Dock='Fill'
    $btnPbip=New-Object System.Windows.Forms.Button; $btnPbip.Text='PBIP...'; $btnPbip.Dock='Fill'
    $btnFolder=New-Object System.Windows.Forms.Button; $btnFolder.Text='Folder...'; $btnFolder.Dock='Fill'
    ...
    $lblReport=New-Object System.Windows.Forms.Label; $lblReport.Text='Not loaded'; $lblReport.Dock='Fill'; $lblReport.TextAlign='MiddleLeft'; $lblReport.ForeColor=[System.Drawing.Color]::DimGray
...
$headerGrid.Controls.Add((New-Label 'Layout Mode'),0,3); $headerGrid.Controls.Add($cmbMode,1,3); $headerGrid.SetColumnSpan($cmbMode,2)
    ...
    $bodySplit.Panel1.BackColor=[System.Drawing.Color]::FromArgb(30,41,59); $bodySplit.Panel1.Padding=New-Object System.Windows.Forms.Padding(12)
    $serviceGrid=New-Object System.Windows.Forms.TableLayoutPanel; $serviceGrid.Dock='Top'; $serviceGrid.ColumnCount=1; $serviceGrid.RowCount=7; $serviceGrid.Height=330
    $bodySplit.Panel1.Controls.Add($serviceGrid)
    $svcTitle=New-Object System.Windows.Forms.Label; $svcTitle.Text='SERVICES'; $svcTitle.ForeColor=[System.Drawing.Color]::LightSteelBlue; $svcTitle.Dock='Fill'; $svcTitle.Font=New-Object System.Drawing.Font('Segoe UI',9,[System.Drawing.FontStyle]::Bold)
    $serviceGrid.Controls.Add($svcTitle,0,0)
    function New-ServiceButton([string]$text) { $b=New-Object System.Windows.Forms.Button; $b.Text=$text; $b.Dock='Fill'; $b.FlatStyle='Flat'; $b.FlatAppearance.BorderSize=0; $b.BackColor=[System.Drawing.Color]::FromArgb(51,65,85); $b.ForeColor=[System.Drawing.Color]::White; $b.Margin=New-Object System.Windows.Forms.Padding(0,4,0,4); return $b }
    ...
    $previewGrid=New-Object System.Windows.Forms.TableLayoutPanel; $previewGrid.Dock='Fill'; $previewGrid.ColumnCount=2; $previewGrid.RowCount=1; $previewGrid.Padding=New-Object System.Windows.Forms.Padding(10)
    [void]$previewGrid.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent,50))); [void]$previewGrid.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent,50)))
    ...
    $beforePanel.Margin=New-Object System.Windows.Forms.Padding(0,0,5,0); $afterPanel.Margin=New-Object System.Windows.Forms.Padding(5,0,0,0)
    $previewGrid.Controls.Add($beforePanel,0,0); $previewGrid.Controls.Add($afterPanel,1,0)

    $console=New-Object System.Windows.Forms.TextBox; $console.Dock='Fill'; $console.Multiline=$true; $console.ReadOnly=$true; $console.ScrollBars='Vertical'; $console.BackColor=[System.Drawing.Color]::FromArgb(15,23,42); $console.ForeColor=[System.Drawing.Color]::FromArgb(226,232,240); $console.Font=New-Object System.Drawing.Font('Consolas',9); $console.BorderStyle='None'
    $rootGrid.Controls.Add($console,0,2)

    $status=New-Object System.Windows.Forms.StatusStrip; $status.Dock='Fill'; $statusLabel=New-Object System.Windows.Forms.ToolStripStatusLabel; $statusLabel.Text='Ready'; [void]$status.Items.Add($statusLabel); $rootGrid.Controls.Add($status,0,3)

    function Add-Activity([string]$Message) { $console.AppendText(('> {0}  {1}' -f (Get-Date -Format 'HH:mm:ss'),$Message)+[Environment]::NewLine); $console.SelectionStart=$console.TextLength; $console.ScrollToCaret(); $statusLabel.Text=$Message; [System.Windows.Forms.Application]::DoEvents() }
    function Show-Error([string]$Message) { Add-Activity ('ERROR: '+$Message); [void][System.Windows.Forms.MessageBox]::Show($form,$Message,'PBI Automate',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) }
    ...
    $btnFolder.Add_Click({
        $dlg=New-Object System.Windows.Forms.FolderBrowserDialog; $dlg.Description='Select PBIP project folder or .Report folder'; $dlg.ShowNewFolderButton=$false
        if ($dlg.ShowDialog($form) -eq [System.Windows.Forms.DialogResult]::OK) { & $loadProject $dlg.SelectedPath }
        $dlg.Dispose()
    })
    ...
    $btnApply.Add_Click({
        try {
            ...
            $answer=[System.Windows.Forms.MessageBox]::Show($form,('Apply layout to '+$state.Layout.ChangedCount+' visual(s)? A backup will be created first.'),'Apply Layout',[System.Windows.Forms.MessageBoxButtons]::YesNo,[System.Windows.Forms.MessageBoxIcon]::Question)
    ...
    $btnUndo.Add_Click({
        try {
            ...
            $answer=[System.Windows.Forms.MessageBox]::Show($form,'Restore the most recent PBI Automate backup for this project?','Undo Last Apply',[System.Windows.Forms.MessageBoxButtons]::YesNo,[System.Windows.Forms.MessageBoxIcon]::Question)
